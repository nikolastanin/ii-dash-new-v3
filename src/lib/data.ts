...
export const RESOURCES: Record<string, Resource> = {
  "tool-ajbell": {
    ...
    sponsored: true,
    featured: true,
    disclosure: "Advertisement — we may earn a commission if you open an account.",
    provider: "AJ Bell",
    title: "Open a Stocks & Shares ISA",
    description: "A low-cost, well-established platform with a wide range of funds and shares.",
    cta: "Open an account",
    url: "#",
  },
  "tool-pensionbee": {
    ...
    type: "tool",
    sponsored: true,
    disclosure: "Advertisement — we may earn a commission if you sign up.",
    provider: "PensionBee",
    title: "Combine your old pensions",
    description: "Track down and merge old workplace pensions into one plan you can see in an app.",
    cta: "Find my pensions",
    url: "#",
  },
  "tool-moneybox": {
    id: "tool-moneybox",
    ...
    disclosure: "Advertisement — we may earn a commission if you sign up.",
    provider: "Moneybox",
    title: "Start investing from £1",
    description: "Round-up investing and a Stocks & Shares ISA built for people just getting started.",
    cta: "Get started",
    url: "#",
  },
  "tool-vanguard": {
    ...
    disclosure: "Advertisement — we may earn a commission if you open an account.",
    provider: "Vanguard",
    title: "Low-cost index funds, direct",
    description: "Access Vanguard's own range of index funds and ETFs, with some of the lowest fees on the market.",
    cta: "Explore Vanguard",
    url: "#",
  },
  "tool-investengine": {
    ...
    title: "Commission-free ISA investing",
    description: "Build a DIY portfolio from ready-made or custom fund mixes with zero platform fees.",
    cta: "Get started",
    url: "#",
  },
